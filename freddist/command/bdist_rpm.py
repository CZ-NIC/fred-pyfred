...
class bdist_rpm(_bdist_rpm):
    ...
    # def run(self):
        # print "running freddist bdist_rpm"
        # print self.bdist_base
        # print self.rpm_base
# 
        # print self.distribution_name 
        # print self.group 
        # print self.release 
        # print self.serial 
        # print self.vendor 
        # print self.packager 
        # print self.doc_files 
        # print self.changelog 
        # print self.icon 
# 
        # print self.prep_script 
        # print self.build_script 
        # print self.install_script 
        # print self.clean_script 
        # print self.verify_script 
        # print self.pre_install 
        # print self.post_install 
        # print self.pre_uninstall 
        # print self.post_uninstall 
        # print self.prep 
        # print self.provides 
        # print self.requires 
        # print self.conflicts 
        # print self.build_requires 
        # print self.obsoletes 
